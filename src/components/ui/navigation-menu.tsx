  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-3xl bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/5 duration-100 md:w-(--radix-navigation-menu-viewport-width) dark:ring-foreground/10 data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90",
          className
        )}
        {...props}
      />
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-full p-3 text-sm transition-all outline-none hover:bg-[#F5F5F5] focus:bg-[#F5F5F5] focus-visible:ring-3 focus-visible:ring-ring/30 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-2xl data-[active=true]:bg-[#FDF4FF] data-[active=true]:font-bold data-[active=true]:text-[#D946EF] data-[active=true]:hover:bg-[#FDF4FF] data-[active=true]:focus:bg-[#FDF4FF] [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
